...
public class CriteriaImplTest {
    ...
    public static void beforeClass() throws Exception {
        entityManager = Persistence.createEntityManagerFactory("AddressBookPU").createEntityManager();
    }
    ...
    public void testAutoJoin() {
        ...
        CriteriaImpl<Company> criteriaImpl = new CriteriaImpl<Company>(Company.class, entityManager);
